...
/// A direct copy-paste job from the standard library, except the `len` and `capacity`
/// fields are `u32` instead of `usize`. This reduces the memory footprint
/// of the type by eight bytes.
///
...
pub fn MultiArrayList(comptime T: type) type {
    return struct {
        ...
        pub const Slice = struct {
            ...
            pub fn set(self: *Slice, index: u32, elem: T) void {
        ...
        pub fn set(self: *Self, index: u32, elem: T) void {
        ...
        pub fn addOne(self: *Self, allocator: Allocator) Allocator.Error!u32 {
        ...
        pub fn insert(self: *Self, gpa: Allocator, index: u32, elem: T) !void {
            try self.ensureUnusedCapacity(gpa, 1);
        ...
        pub fn insertAssumeCapacity(self: *Self, index: u32, elem: T) void {
            assert(self.len < self.capacity);
